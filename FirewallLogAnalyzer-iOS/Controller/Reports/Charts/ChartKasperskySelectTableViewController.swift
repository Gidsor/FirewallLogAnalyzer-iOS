//
//  ChartKasperskySelectTableViewController.swift
...
class ChartKasperskySelectTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "CreateReport", let destination = segue.destination as? ChartKasperskyReportTableViewController {
            ...
            destination.logs = kasperskyLogs
        }
    }
