//
//  SearchTPLinkSelectTableViewController.swift
...
class SearchTPLinkSelectTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "CreateReport", let destination = segue.destination as? SearchTPLinkReportTableViewController {
